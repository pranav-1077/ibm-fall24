...
The flow proposed in this project reduces end-to-end dataset creation time from weeks to < 5 hours, suggesting potential in building more scalable training systems for geospatial captioning.
